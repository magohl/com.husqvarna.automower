...
module.exports = class AutomowerApiUtil {
  ...
  async _login() {
    const username = this.homey.settings.get('username').trim();
    const password = this.homey.settings.get('password').trim();
    const appkey = this.homey.settings.get('appkey').trim();
    const appsecret = this.homey.settings.get('appsecret').trim();
  ...
  async getMower(mowerId) {
    let appkey = this.homey.settings.get('appkey').trim();
